...
.diagrams-container {
  ...
  max-height: calc(100vh - 64px); /* Match viewport height minus padding */
  scrollbar-width: thin; /* For Firefox */
  scrollbar-color: #05A696 #e5e7eb; /* Scrollbar style */
}
...
.menu-header {
  ...
  padding: 20px;
  cursor: pointer;
  background: linear-gradient(90deg, #05A696,rgb(126, 230, 220));
...
.settings-field {
  background: linear-gradient(90deg, #05A696,rgb(140, 247, 242));
  color: #ffffff;
  padding: 8px 16px;
  border-radius: 8px;
  font-size: 1rem;
...
.add-option-button {
  background: linear-gradient(90deg, #05A696,rgb(101, 246, 202));
  color: #ffffff;
  padding: 8px 16px;
  border-radius: 8px;
  font-size: 1rem;

...
import StromverbrauchRechner from '../EWR1/details18'; // Import der Details-Rechner-Komponente
            ...
            <div className="flex h-full flex-col justify-between">
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <a href="/EWR1/details" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl bg-blue-950 hover:bg-blue-800 text-white active">

                      ...
                      {calculateWeeklyAverages(selectedMonth, monthlyData[selectedMonth]).map((week, i) => {
                        ...
                        return (
                          <tr key={week.kw} className={i % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                            <td className="p-3 text-black">KW {week.kw}</td>
                            <td className="p-3 text-black">{getWeekDateRange(week.days)}</td>
                            <td className="p-3 text-black">{week.average}</td>
                            <td className="p-3 text-black">{weeklyKwh}</td>
                            <td className="p-3 text-black">{kosten}</td>
                            <td className="p-3 text-black">{kostenEigenerPreis}</td>
                          </tr>
                        );
                      })}
                    </tbody>

...
import Dypreis0 from '../EWR1/dypreis0';
      ...
      <div className="layout relative bg-gray-100" style={{ fontFamily: 'Manrope, "Noto Sans", sans-serif' }}>
        ...
        <div className="top-box p-6 rounded-xl bg-white border border-gray-300">
          <div className="flex flex-col gap-3 rounded-xl p-6 bg-gray-50 shadow-sm text-center">
            <div className="flex items-center justify-center gap-4">
              <p className="text-[#D9043D] text-2xl font-bold leading-normal">Preisrechner dynamische Tarife</p>
              <a
                href="/EWR1/rechner"
                className="inline-flex items-center justify-center gap-1 px-3 py-1 rounded-lg bg-[#D9043D] hover:bg-[#05A696] text-white text-sm font-medium leading-normal"
              >
                <FontAwesomeIcon icon={faCalculator} style={{ color: '#05A696', fontSize: '14px' }} />
                Zum Rechner
              </a>
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-1">
                ...
                <a href="/EWR1/preise" className="flex flex-col items-center gap-1 px-2 py-1 hover:bg-[#D9043D] text-white">
                  <FontAwesomeIcon icon={faChartLine} style={{ color: '#05A696', fontSize: '20px' }} />
                ...
                <a href="/EWR1/rechner" className="flex flex-col items-center gap-1 px-2 py-1 hover:bg-[#D9043D] text-white">
                  <FontAwesomeIcon icon={faCalculator} style={{ color: '#05A696', fontSize: '20px' }} />
          ...
          <div className="content flex-1 p-6 rounded-xl bg-white shadow-md flex flex-col">
            ...
            <div className="flex flex-col gap-6 mt-6 flex-1">
              <div className="flex min-w-[200px] flex-1 flex-col gap-3 rounded-xl p-6 border border-gray-300 bg-gray-50 shadow-sm">
                <p className="text-[#D9043D] text-2xl font-bold leading-normal">Was ist ein dynamischer Stromtarif?</p>
                <p className="text-[#202026] text-base font-normal leading-normal">
        ...
        <div className="bottom-boxes">
          <div className="flex flex-col gap-4 rounded-xl p-6 bg-gray-50 shadow-sm border border-[#05A696]">
            <p className="text-[#D9043D] text-xl font-bold leading-normal">Vorteile</p>
          ...
          <div className="flex flex-col gap-4 rounded-xl p-6 bg-gray-50 shadow-sm border border-[#D9043D] mt-4">
            <p className="text-[#D9043D] text-xl font-bold leading-normal">Nachteile</p>
            <ul className="text-[#202026] text-base font-normal leading-relaxed list-disc list-inside space-y-2">
        ...
        <div className="extra-box-2">
          <div className="inner-box flex flex-col gap-3 rounded-xl p-4 bg-gray-50 shadow-sm border border-gray-300 text-center">
            <p className="text-[#D9043D] text-lg font-medium leading-normal">Jetzt berechnen, ob der dynamischer Stromtarif für Sie in Frage kommt.</p>
            <p className="text-[#202026] text-base font-normal leading-normal">
              <a

    ...
    <>
      ...
      <div className="layout relative bg-gray-100" style={{ fontFamily: 'Manrope, "Noto Sans", sans-serif' }}>
          ...
          <div className="flex h-full flex-col justify-between">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-1">
                <a href="/test15/startseite" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl hover:bg-[#063d37] text-white">
                  <FontAwesomeIcon icon={faHouse} style={{ color: '#fafafa' }} />
                  <p className="text-white text-xs font-medium leading-normal">Home</p>
                </a>
                <a href="/test15/preise" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl hover:bg-[#063d37] text-white">
                  <FontAwesomeIcon icon={faChartLine} style={{ color: '#fafafa' }} />
                  <p className="text-white text-xs font-medium leading-normal">Preis</p>
                </a>
                <a href="/test15/rechner" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl bg-[#063d37] text-white active">
                  <FontAwesomeIcon icon={faCalculator} style={{ color: '#FFFFFF' }} />
                  <p className="text-white text-xs font-medium leading-normal">Rechner</p>
                </a>
                <a href="/test15/details" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl hover:bg-[#063d37] text-white">
                ...
                <a href="/test15/hilfe" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl hover:bg-[#063d37] text-white">
        ...
        <nav className="bottom-nav">
          ...
          <a href="/test15/preise" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl bg-transparent hover:bg-[#063d37] text-white">
          ...
          <a href="/test15/details" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl bg-transparent hover:bg-[#063d37] text-white">
          ...
          <a href="/test15/hilfe" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl bg-transparent hover:bg-[#063d37] text-white">

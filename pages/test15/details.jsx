...
export default function StromverbrauchRechnerDesktop({ data = [], uniqueDates = [], todayBerlin, error: propError }) {
  ...
  const chartOptions = {
    ...
    plugins: {
      ...
      title: { display: true, text: 'Stromverbrauch und Dynamischer Preis pro 15-Minuten', color: '#333', font: { size: 16 } },
      tooltip: {
        callbacks: {
  ...
  const chartDataKosten = {
    ...
    datasets: [
      {
        label: 'Kosten Dynamischer Tarif ohne Wärmepumpe (Ct/h)',
      ...
      {
        label: 'Kosten Dynamischer Tarif Wärmepumpe (Ct/h)',
  ...
  const chartOptionsKosten = {
    ...
    plugins: {
      legend: { position: 'top', labels: { color: '#333' } },
      title: { display: true, text: `Kosten pro 15-Minuten am ${selectedDate || 'Fallback'}`, color: '#333', font: { size: 16 } },
      tooltip: {
        callbacks: {
          label: function(context) {
            const label = context.dataset.label || '';
    ...
    scales: {
      y: {
        beginAtZero: true,
        title: { display: true, text: 'Kosten (Ct/h)', color: '#333' },
        ticks: { color: '#333' },
      },
      x: {
        title: { display: true, text: 'Uhrzeit', color: '#333' },
              ...
              <div className="flex h-full flex-col justify-between">
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-col gap-1">
                    <a href="/test15/startseite" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl bg-[#202026] hover:bg-[#063d37] text-white">
                    ...
                    <a href="/test15/preise" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl bg-[#202026] hover:bg-[#063d37] text-white">
                    ...
                    <a href="/test15/rechner" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl bg-[#202026] hover:bg-[#063d37] text-white">
                    ...
                    <a href="/test15/details" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl bg-[#063d37] text-white active">

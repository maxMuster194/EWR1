...
export default function MongoDBPricesPage() {
  ...
  const calculateWeeklyAverages = (monthKey) => {
    ...
    // Berechne die Gesamtzahl der Tage im Monat für die Wochen, die zum Monat gehören
    ...
    const weeklyAverages = weeks.map((week) => {
      ...
      // Berechne wöchentlichen Verbrauch anteilig basierend auf der Anzahl der Tage
                    ...
                    <table className="w-full border-collapse bg-white rounded-lg shadow-md text-xs sm:text-sm">
                      ...
                      <tbody>
                        {calculateWeeklyAverages(selectedMonth).map((week, i) => {
                          ...
                          return (
                            <tr key={week.kw} className={i % 2 === 0 ? 'bg-[#fafafa]' : 'bg-white'}>
                              ...
                              <td className="p-2 sm:p-3 text-[#063d37]">{week.weeklyKwh}</td>
                    ...
                    <Bar
                      ...
                      options={{
                        ...
                        scales: {
                          ...
                          x: {
                            ticks: { color: '#063d37', font: { size: 10 } },
                            grid: { color: 'rgba(6, 61, 55, 0.1)' },
                          },
                        },
                      }}

...
export default function WeeklyPriceChart() {
  ...
  if (loading) {
    return <div className="text-center p-4 text-lg text-[#4372b7] bg-[#fafafa] rounded-2xl">⏳ Laden…</div>;
  }

  if (!Object.keys(data).length) {
    return <div className="text-center p-4 text-lg text-[#4372b7] bg-[#fafafa] rounded-2xl">⚠️ Keine Daten</div>;
  }

  const yearlyAverages = calculateYearlyAverages();

  return (
    <div className="max-w-full mx-auto p-4 bg-[#fafafa] rounded-2xl">

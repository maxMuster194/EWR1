...
const styles = `
  ...
  @media (max-width: 767px) {
    ...
    .header, .footer, .sidebar, .main, .top-box, .bottom-boxes, .extra-box-2 {
      width: 100%;
      padding: 12px;
    }
    .extra-box-2 .inner-box {
      ...
      <div className="layout relative bg-gray-100" style={{ fontFamily: 'Manrope, "Noto Sans", sans-serif' }}>
        <header className="header flex items-center justify-between whitespace-nowrap border-b border-gray-300 px-12 py-4 bg-blue-200">
          <div className="flex items-center gap-5 text-gray-800">
            ...
            <h2 className="text-gray-800 text-xl font-bold leading-tight tracking-[-0.015em]">Energiemanager</h2>
          </div>
        </header>
        ...
        <div className="top-box p-6 rounded-xl bg-white border border-gray-300">
          <div className="flex flex-col gap-3 rounded-xl p-6 bg-gray-50 shadow-sm text-center">
            <div className="flex items-center justify-center gap-4">
              <p className="text-gray-800 text-2xl font-bold leading-normal">Preisrechner dynamische Tarife</p>
              <a
                href="/calculator"
        ...
        <div className="main">
          <div className="content p-6 rounded-xl bg-white">
            <p className="text-gray-800 tracking-tight text-3xl font-bold leading-tight text-center"></p>
            ...
            <div className="flex flex-col gap-6 mt-6">
              <div className="flex min-w-[200px] flex-1 flex-col gap-3 rounded-xl p-6 border border-gray-300 bg-gray-50 shadow-sm">
                <p className="text-gray-800 text-2xl font-bold leading-normal">Was ist ein dynamischer Stromtarif?</p>
                <p className="text-gray-600 text-base font-normal leading-normal">
          ...
          <div className="chart p-6 rounded-xl bg-white">
            <div className="flex flex-col gap-6 px-6 py-6">
              <div className="flex min-w-[200px] flex-1 flex-col gap-3 rounded-xl border border-gray-300 p-6 bg-gray-50 shadow-sm">
                <p className="text-gray-800 text-lg font-medium leading-normal">Stromverbrauch im Zeitverlauf</p>
                <p className="text-gray-800 tracking-tight text-2xl font-bold leading-tight truncate">1200 kWh</p>
                <div className="flex gap-2">
        ...
        <div className="bottom-boxes">
          <div className="flex flex-col gap-4 rounded-xl p-6 bg-gray-50 shadow-sm border border-gray-300">
            <p className="text-green-600 text-xl font-bold leading-normal">Vorteile</p>
            <ul className="text-base font-normal leading-relaxed list-disc list-inside space-y-2">
              <li><span className="font-medium text-green-600">Kostenersparnis:</span> <span className="text-green-700">Wer seinen Stromverbrauch in günstige Zeiten verlegt (z. B. Wäsche nachts waschen), kann spürbar sparen.</span></li>
              <li><span className="font-medium text-green-600">Transparenz:</span> <span className="text-green-700">Nutzer sehen, wann Strom teuer oder billig ist, und können entsprechend reagieren.</span></li>
              <li><span className="font-medium text-green-600">Umweltfreundlich:</span> <span className="text-green-700">Fördert die Nutzung von erneuerbaren Energien, wenn diese im Überfluss verfügbar sind.</span></li>
              <li><span className="font-medium text-green-600">Anreiz zur Automatisierung:</span> <span className="text-green-700">Smarte Haushaltsgeräte oder Energiemanagementsysteme lassen sich optimal einsetzen.</span></li>
            </ul>
          </div>
          <div className="flex flex-col gap-4 rounded-xl p-6 bg-gray-50 shadow-sm border border-gray-300 mt-4">
            <p className="text-red-600 text-xl font-bold leading-normal">Nachteile</p>
            <ul className="text-base font-normal leading-relaxed list-disc list-inside space-y-2">
              <li><span className="font-medium text-red-600">Preisschwankungen:</span> <span className="text-red-700">Strom kann zu bestimmten Tageszeiten sehr teuer sein, was die Planung erschwert.</span></li>
              <li><span className="font-medium text-red-600">Technischer Aufwand:</span> <span className="text-red-700">Ein digitaler Stromzähler (Smart Meter) ist meist Voraussetzung.</span></li>
              <li><span className="font-medium text-red-600">Komplexität:</span> <span className="text-red-700">Erfordert aktives Mitdenken oder technische Lösungen, um vom günstigen Preis zu profitieren.</span></li>
              <li><span className="font-medium text-red-600">Unvorhersehbarkeit:</span> <span className="text-red-700">Bei starker Nachfrage oder Krisen können Preise unerwartet steigen.</span></li>
            </ul>
          </div>
        </div>
        ...
        <div className="extra-box-2">
          <div className="inner-box flex flex-col gap-3 rounded-xl p-4 bg-gray-50 shadow-sm border border-gray-300 text-center">
            <p className="text-gray-800 text-lg font-medium leading-normal">Jetzt berechnen, ob der dynamischer Stromtarif für Sie in Frage kommt.</p>
            <p className="text-gray-600 text-base font-normal leading-normal">
              <a
                href="/calculator"
                className="inline-flex items-center justify-center gap-1 px-3 py-1 rounded-lg bg-blue-400 hover:bg-blue-300 text-white text-sm font-medium leading-normal"
        ...
        <footer className="footer flex items-center justify-center whitespace-nowrap border-t border-gray-300 px-12 py-4 bg-blue-200">
          <p className="text-gray-800 text-base font-medium leading-normal">© 2025 Energiemanager</p>
        </footer>
      </div>
    </>
  );

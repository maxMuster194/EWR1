...
const styles = `
  ...
  @media (max-width: 767px) {
    ...
    .header, .footer, .sidebar, .main, .top-box, .bottom-boxes {
      width: 100%;
      padding: 12px;
    }
    .main, .bottom-boxes {
    ...
    .content .flex-col, .chart .flex-col, .bottom-box .flex-col {
      flex-direction: column;
      align-items: center;
    }
    .content .flex-col > div, .chart .flex-col > div, .bottom-box .flex-col > div {
      width: 100%;
      margin-bottom: 10px;
    }
  }
    ...
    <>
      ...
      <div className="layout relative bg-gray-800" style={{ fontFamily: 'Manrope, "Noto Sans", sans-serif' }}>
        ...
        <div className="top-box p-6 rounded-xl bg-gray-600 border border-purple-700">
          <div className="flex flex-col gap-3 rounded-xl p-6 bg-gray-700 shadow-lg">
            <p className="text-white text-lg font-medium leading-normal">Willkommen</p>
            <p className="text-blue-200 text-base font-normal leading-normal">
              Hier finden Sie eine Übersicht Ihrer Energiedaten und nützliche Tipps zur Optimierung.
            </p>
          </div>
        </div>
        ...
        <div className="main">
          <div className="content p-6 rounded-xl bg-gray-600">
            <p className="text-white tracking-tight text-3xl font-bold leading-tight text-center">Preisrechner Dynamische Tarife</p>
            <p className="text-blue-200 text-lg font-normal leading-relaxed text-center mt-2">
              Entdecken Sie in wenigen Schritten, ob ein dynamischer Stromtarif für Ihren Haushalt geeignet ist.
            </p>
            <div className="flex flex-col gap-6 mt-6">
              <div className="flex min-w-[200px] flex-1 flex-col gap-3 rounded-xl p-6 border border-purple-700 bg-gray-700 shadow-lg">
                <p className="text-white text-lg font-medium leading-normal">Tarifrechner</p>
                <p className="text-blue-200 text-base font-normal leading-normal">
                  Geben Sie Ihren Verbrauch ein, um die Kosten zu berechnen.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bottom-boxes">
          <div className="bottom-box p-6 rounded-xl bg-gray-600">
            <div className="flex flex-col gap-3 rounded-xl p-6 bg-gray-700 shadow-lg">
              <p className="text-white text-lg font-medium leading-normal">Energieeinsparung</p>
              <p className="text-blue-200 text-base font-normal leading-normal">
                Tipps und Tricks zur Reduzierung Ihres Stromverbrauchs.
              </p>
            </div>
          </div>
          <div className="bottom-box p-6 rounded-xl bg-gray-600">
            <div className="flex flex-col gap-3 rounded-xl p-6 bg-gray-700 shadow-lg">
              <p className="text-white text-lg font-medium leading-normal">Tarifvergleich</p>
              <p className="text-blue-200 text-base font-normal leading-normal">
                Vergleichen Sie verschiedene Stromtarife, um die beste Option zu finden.
              </p>
            </div>
          </div>
        </div>

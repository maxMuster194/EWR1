...
const styles = `
  ...
  .content-wrapper {
    ...
    grid:
      ...
      / minmax(100px, 120px) 1fr; /* Narrower sidebar */
    gap: 1rem; /* Vertical and horizontal gap */
    padding: 2rem 1rem 1rem 0; /* Added top padding for spacing from header */
  ...
  .sidebar {
    ...
    border: 1px solid #D1D5DB;
    border-radius: 12px 0 0 12px; /* Rounded corners only on left side */
    box-sizing: border-box;
  }
  .sidebar .flex {
    display: flex;
      ...
      <div className="layout relative bg-gray-100" style={{ fontFamily: 'Manrope, "Noto Sans", sans-serif' }}>
        ...
        <div className="content-wrapper">
            ...
            <div className="flex h-full flex-col justify-between">
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-1">
                  <a
                    href="/Amberg1/startseite"
                    className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl hover:bg-blue-800 text-white"
                  >
                  ...
                  <a href="/Amberg1/rechner" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl bg-blue-950 hover:bg-blue-800 text-white">
          ...
          <div className="bottom-boxes">
            <div className="flex flex-col gap-4 rounded-xl p-6 bg-gray-50 shadow-sm">
              <p className="text-blue-600 text-xl font-bold leading-normal"></p>
              <div className="content-box flex min-w-[150px] flex-1 flex-col gap-3 rounded-xl bg-gray-50 shadow-sm">
                <div>
                  <Statistik />
                </div>

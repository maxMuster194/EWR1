          ...
          <div className="flex h-full flex-col justify-between">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-1">
                ...
                <a href="/layout1/preise" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl bg-[#062316] text-white active">
                ...
                <a href="/layout1/rechner" className="flex flex-col items-center gap-1 px-2 py-1 hover:bg-[#062316] text-white">
                ...
                <a href="/layout1/details" className="flex flex-col items-center gap-1 px-2 py-1 hover:bg-[#062316] text-white">
                ...
                <a href="/layout1/hilfe" className="flex flex-col items-center gap-1 px-2 py-1 hover:bg-[#062316] text-white">

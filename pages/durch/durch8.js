...
const styles = {
  container: {
    ...
    borderRadius: '20px',
    boxShadow: '0 8px 30px rgba(32, 32, 38, 0.1)',
  },
  title: {
    fontSize: '2.25rem',
    fontWeight: '700',
  ...
  inputContainer: {
    ...
    borderRadius: '16px',
    boxShadow: '0 6px 20px rgba(32, 32, 38, 0.08)',
    display: 'flex',
  ...
  input: {
    ...
    ':hover': {
      borderColor: '#D9043D',
      boxShadow: '0 0 8px rgba(217, 4, 61, 0.2)',
    },
    ':focus': {
      borderColor: '#D9043D',
      boxShadow: '0 0 8px rgba(217, 4, 61, 0.3)',
    },
  },
  select: {
    padding: '1rem',
  ...
  card: {
    padding: '2.5rem',
    background: 'linear-gradient(135deg, #05A696 0%, #028a7b 100%)',
    borderRadius: '16px',
    boxShadow: '0 6px 20px rgba(32, 32, 38, 0.15)',
    textAlign: 'center',
    cursor: 'pointer',
    ...
    ':hover': {
      ...
      boxShadow: '0 10px 30px rgba(5, 166, 150, 0.3)',
    },
  },
  selectedCard: {
    background: 'linear-gradient(135deg, #D9043D 0%, #b00333 100%)',
    boxShadow: '0 10px 30px rgba(217, 4, 61, 0.4)',
    color: '#ffffff',
    width: '240px',
    height: '200px',
    transform: 'translateY(-5px)',
  ...
  monthlyAverage: {
    ...
    marginBottom: '1rem',
    borderRadius: '12px',
    boxShadow: '0 4px 12px rgba(5, 166, 150, 0.2)',
    fontSize: '1.1rem',
    fontWeight: '500',
    display: 'flex',
    alignItems: 'center',
  ...
  modalOverlay: {
    ...
    right: 0,
    bottom: 0,
    backgroundColor: 'rgba(32, 32, 38, 0.6)',
    display: 'flex',
    justifyContent: 'center',
    alignItems: 'center',
    zIndex: 1000,
  ...
  modalContent: {
    ...
    maxHeight: '85vh',
    overflowY: 'auto',
    boxShadow: '0 8px 30px rgba(32, 32, 38, 0.2)',
    position: 'relative',
  },
  modalCloseButton: {
    position: 'absolute',
...
// calendarWeeks object remains unchanged
const calendarWeeks = {
  '01/2025': [
...
export default function MongoDBPricesPage() {
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.title}>Durchschnittspreise</h1>

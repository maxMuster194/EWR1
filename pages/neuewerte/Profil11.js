...
function StrompreisChart() {
  ...
  const rawStrompreisValues = selectedStrompreisIndex !== -1 ? strompreisData[selectedStrompreisIndex]?.__parsed_extra.slice(0, 24) : []; // Angenommen stündliche Werte (24)

  // Erweitere die stündlichen Werte auf 15-Min-Intervalle (jeden Wert 4x wiederholen)

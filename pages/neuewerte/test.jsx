...
import Statistik from '../neuewerte/stk4';
import Durchschnitt from '../neuewerte/durch12';
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-1">
                ...
                <a
                  ...
                  className="flex flex-col items-center gap-1 px-2 py-1 hover:bg-[#D9043D] text-white"
                >

            ...
            <button
              ...
              className={`px-4 py-2 text-lg font-medium rounded-lg transition-all ${
                selectedDiscount?.label === discount.label
                  ? 'bg-[#062316] text-white shadow-md'
                  : 'bg-[#409966] text-white hover:bg-[#062316]'
              }`}
                    ...
                    <Bar
                      ...
                      options={{
                        ...
                        plugins: {
                          ...
                          tooltip: {
                            backgroundColor: '#062316', // Dunkelgrün
                        ...
                        scales: {
                          y: {
                            ...
                            grid: { color: 'rgba(6, 35, 22, 0.1)' }, // Dunkelgrün mit Transparenz
                          },
                          x: {
                            ticks: { color: '#062316' }, // Dunkelgrün
                            grid: { color: 'rgba(6, 35, 22, 0.1)' }, // Dunkelgrün mit Transparenz
                          },
                        },
                      }}

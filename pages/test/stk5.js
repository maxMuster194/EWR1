...
const styles = {
  ...
  title: {
    ...
    color: '#062316',
    textAlign: 'center',
    wordBreak: 'break-word', // verhindert horizontales Scrollen
  },
  chartContainer: {
    marginTop: '2rem',
    padding: '1rem',
  ...
  chartTitle: {
    fontSize: '1.5rem', // kleiner für Mobile
    fontWeight: '600',
    marginBottom: '1rem',
    color: '#062316',
    textAlign: 'center',
            ...
            <Line
              ...
              options={{
                ...
                plugins: {
                  legend: {
                    position: 'top',
                    labels: { font: { size: 12, weight: '500' }, color: '#062316' },
                  },
                  tooltip: {
                ...
                scales: {
                  ...
                  y: {
                    beginAtZero: true,
                    grid: { color: 'rgba(64, 153, 102, 0.1)' },
                    ticks: { color: '#062316', font: { size: isMobile ? 8 : 10 }, callback: (v) => `${v.toFixed(2)} ct` },
                  },
                },
              }}
            />

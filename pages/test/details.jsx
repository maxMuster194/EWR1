...
import StromverbrauchRechnerDesktop from './details36'; // Für Desktop/Tablet
    ...
    <>
      ...
      <div className="layout relative  bg-[#fafafa]" style={{ fontFamily: 'Manrope, "Noto Sans", sans-serif' }}>
        ...
        <nav className="bottom-nav">
          ...
          <a href="/test/rechner" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl bg-transparent hover:bg-[#063d37] text-white">

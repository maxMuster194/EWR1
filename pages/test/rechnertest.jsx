...
import Profil9 from './Profil9';
import Profil10 from './Profil11';
...
const styles = `
  ...
  @media (max-width: 767px) {
    ...
    .main {
      ...
      border: none;
      border-radius: 0;
      min-height: calc(100vh - 3rem - 4rem - 4rem); /* Adjust for header, footer, and bottom-nav heights */
      display: flex;
      flex-direction: column;
      flex-grow: 1;
      background-color: #F3F4F6;
    ...
    .bottom-nav {
      ...
      padding: 8px 0;
      z-index: 1000;
      height: 4rem; /* Explicit height for bottom-nav */
    }
    .bottom-nav a {
      display: flex;
      flex-direction: column;
...
const Energiemanager = () => {
  const [isMobile, setIsMobile] = useState(false); // Initialize without window

...
.app-container {
  ...
  padding: 12px;
  min-height: 100vh;
  padding-top: 352px; /* Angepasst: 300px + 12px + 40px */
}

/* Fixierter Chart-Bereich */
.fixed-chart {
  position: fixed;
  top: 40px; /* Angepasst: 20px + 20px */
  left: 0;
  right: 0;
  z-index: 10;
  background: #ffffff;
...
@media (max-width: 768px) {
 ...
 .app-container {
    padding: 4.8px; /* 4px * 1.2 */
    gap: 4.8px; /* 4px * 1.2 */
    padding-top: 292.8px; /* Angepasst: 240px * 1.2 + 4.8px + 44px */
  }

  .fixed-chart {
    position: fixed;
    top: 80px; /* Angespasst chart header 
    left: 0;
    right: 0;
    padding: 4.8px; /* 4px * 1.2 */
    border-radius: 0 0 7.2px 7.2px; /* 6px * 1.2 */
    z-index: 10;
  }

  .chart-container {
    height: 240px; /* 200px * 1.2 */
  }
  ...
  .region-buttons {
    ...
    justify-content: center;
    align-items: center;
    margin: 4.8px 0; /* 4px * 1.2 */
    padding: 4.8px; /* 4px * 1.2 */
    background: #ffffff;
    border-radius: 7.2px; /* 6px * 1.2 */
    box-shadow: 0 1.2px 4.8px rgba(0, 0, 0, 0.1); /* 1px * 1.2, 4px * 1.2 */
  }

  .region-switch-wrapper {
    min-width: 48px; /* 40px * 1.2 */
  }

  .region-label {
    font-size: 0.84rem; /* 0.7rem * 1.2 */
  }
  ...
  .inputs-wrapper {
    ...
    align-items: stretch;
    background: #ffffff;
    padding: 7.2px; /* 6px * 1.2 */
    border-radius: 9.6px; /* 8px * 1.2 */
    box-shadow: 0 2.4px 9.6px rgba(0, 0, 0, 0.1); /* 2px * 1.2, 8px * 1.2 */
  ...
  .checkbox-group-header {
    font-size: 0.78rem; /* 0.65rem * 1.2 */
    padding: 4.8px 0; /* 4px * 1.2 */
    gap: 4.8px; /* 4px * 1.2 */
    grid-template-columns: 30px 1fr 48px 60px 60px 30px; /* 25px * 1.2, 40px * 1.2, 50px * 1.2, 25px * 1.2 */
  }
  ...
  .info-field .tooltip-text {
    font-size: 0.72rem; /* 0.6rem * 1.2 */
    padding: 2.4px 3.6px; /* 2px * 1.2, 3px * 1.2 */
  }
  ...
  .input-group input.watt-input {
    padding: 3.6px 4.8px; /* 3px * 1.2, 4px * 1.2 */
    font-size: 0.78rem; /* 0.65rem * 1.2 */
  }
  ...
  .bar-color-red,
  .bar-color-green {
    padding: 3.6px 7.2px; /* 3px * 1.2, 6px * 1.2 */
    font-size: 0.78rem; /* 0.65rem * 1.2 */
  }
  ...
  .dark-mode-toggle {
    padding: 4.8px 9.6px; /* 4px * 1.2, 8px * 1.2 */
    font-size: 0.78rem; /* 0.65rem * 1.2 */
  }
}`}</style>
...
{menus.map((menu) => (
                      ...
                      {erweiterteEinstellungen[option.name]?.zeitraeume?.map(
                        (zeitraum) => (
                          ...
                          >
                              ...
                              {/* Nutzung pro Woche */}
  <div className="flex flex-col items-center justify-center flex-1 border rounded-md p-3 bg-white shadow-sm">
    <span className="text-sm font-semibold text-gray-700">Nutzung pro Woche</span>
    <span className="text-lg font-bold text-blue-600">{erweiterteEinstellungen[option.name]?.nutzung || 0}</span>
    <input
      type="range"
      min="0"
      max="14"
  ...
  {/* Dauer */}
  <div className="flex flex-col items-center justify-center flex-1 border rounded-md p-3 bg-white shadow-sm">
    <span className="text-sm font-semibold text-gray-700">Dauer (h)</span>
    <span className="text-lg font-bold text-blue-600">{zeitraum.dauer || 0}</span>
    <input
      type="range"
      min="0"
      max="10"
...
<button
            className="add-option-button bg-blue-600 text-white rounded-md px-2 py-1 hover:bg-blue-700 text-xs mt-2"
            onClick={() => addZeitraum(option.name)}
          >
            Zeitraum +
          </button>

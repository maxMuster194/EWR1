        ...
        <div className="sidebar">
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1">
              <a href="/test/startseite" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl text-white">
                <FontAwesomeIcon icon={faHouse} style={{ color: '#fafafa', fontSize: '20px' }} />
                <p>Home</p>
              </a>
              <a href="/test/preise" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl text-white">
                <FontAwesomeIcon icon={faChartLine} style={{ color: '#fafafa', fontSize: '20px' }} />
                <p>Preis</p>
              </a>
              <a href="/test/rechner" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl text-white">
                <FontAwesomeIcon icon={faCalculator} style={{ color: '#fafafa', fontSize: '20px' }} />
                <p>Rechner</p>
              </a>
              <a href="/test/details" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl text-white">
                <FontAwesomeIcon icon={faFileLines} style={{ color: '#fafafa', fontSize: '20px' }} />
                <p>Detail-Rechner</p>
              </a>
              <a href="/test/hilfe-videos" className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl text-white active">

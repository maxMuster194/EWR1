...
import GermanyMin15PricesOld from '../../models/min15PricesOld'; // Adjusted to new model name

const mongoURI = process.env.MONGO_URI || 'mongodb+srv://max:Julian1705@strom.vm0dp8f.mongodb.net/old_prices?retryWrites=true&w=majority&appName=Strom';
...
export default async function handler(req, res) {
  try {
    await connectDB();
    const data = await GermanyMin15PricesOld.find({}).lean();
